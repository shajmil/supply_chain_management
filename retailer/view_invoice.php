...
$sql =" SELECT  invoice.date,invoice.order_id,invoice.status,invoice.dist_id,distributor.dist_name,distributor.dist_address,distributor.dist_phone,distributor.dist_email,distributor.dist_photo,distributor.status,manufacturer.man_id,manufacturer.man_name,manufacturer.man_phone,manufacturer.man_email FROM `invoice`
...
<div class="page-wrap">
    <div class="ps-section--hero">
        <div class="ps-section__content text-center">
            <br><br><br>
            <h3 class="ps-section__title">INVOICE</h3>
            <div class="ps-breadcrumb">
                <ol class="breadcrumb">
                    <li><a href="view_order.php">ORDERS</a></li>
                    <li class="active">MY INVOICE</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="invoice">
                ...
                <div class="invoice-header">
                    ...
                    <div class="invoice-to">
                        ...
                        <address class="m-t-5 m-b-5">
                            <strong class="text-inverse"><?php echo  $results['dist_name']; ?></strong><br>
                            <!-- <img src="../images/<?php echo $results['dist_photo']; ?>" height="45px" alt=""><br> -->
                            Phone: <?php echo  $results['dist_phone'];  ?><br>
                            email: <?php echo  $results['dist_email'];  ?>
                        </address>
                    </div>
            ...
            ?>
                    ...
                    <div class="invoice-price">
                        <div>
                            ...
                            <?php  if($results['status'] != 3)
                            {
                               $id = $results['dist_id'];
                           ?>
                            <a href="functions/update_dist.php?id=<?php echo $id;?>&&or=<?php echo $order_id;;?>"><button
                                    type="button" class="btn btn-sm btn-white m-b-10 p-l-5">I GOT MY ORDER</a>
                            <?php }?>
                        </div>
                ...
                <div class="invoice-note">
                    ...
                    * If you have any questions concerning this invoice, contact [<?php echo $results['man_name']; ?>,
                    <?php echo $results['man_phone']; ?>, <?php echo $results['man_email']; ?>]
                </div>
                <!-- end invoice-note -->
