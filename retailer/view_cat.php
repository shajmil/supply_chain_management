...
$sq =" SELECT  products.pro_id,manufacturer.man_name, products.pro_name,products.pro_cat,categories.cat_name,products.pro_price,products.pro_photo,unit.unit_name FROM products 
        ...
        <div class="container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                <div class="ps-section__header mb-50">
                    <h3 class="ps-section__title ps-section__title--left"><?php echo $results['cat_name']; ?></h3>
                </div>
                 ...
                 ?>
                    <div class="ps-product--list">
                        <div class="ps-product__thumbnail"><a class="ps-product__overlay" href=""></a><img
                                src="../images/<?php echo $ro['pro_photo']; ?>" alt="" width="180" height="200"></div>
                        <div class="ps-product__content">
                            <h4 class="ps-product__title"><a href=""></a><?php echo $ro['pro_name']; ?></h4>
                            <p>MANUFACTURED BY:<?php echo $ro['man_name']; ?></p>
                            <p class="ps-product__price">
                                <del>£25.00</del><?php echo $ro['pro_price']; ?>
                            </p><a class="ps-btn ps-btn--xs" href="create_order.php">Order now<i
