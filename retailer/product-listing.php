...
// echo $sum;
  ...
  ?>
                  ...
                  <div class="ps-product--list ps-product--list-large">
                    <div class="ps-product__thumbnail"><a class="ps-product__overlay" href=""></a><img src="../images/<?php echo $row['pro_photo']; ?>" alt="">
                    ...
                    <div class="ps-product__content">
                      ...
                      <footer class="ps-product__footer clearfix"><a class="ps-btn ps-btn--sm" href="create_order.php">Order now<i class="fa fa-angle-right"></i></a>
                              ...
                              <aside class="ps-widget ps-widget--sidebar ps-widget--category">
                                ...
                                <div class="ps-widget__content">
                                  <ul class="ps-list--circle">
                                    <li class="current"><a href="product-listing.php"><span class="circle"></span>All bakery</a></li>
                                    
<?php foreach($result as $row) {
  ?>
                                    <li><a href="view_cat.php?id=<?php echo $row['cat_id']; ?>"><span class="circle"></span><?php echo $row['cat_name']; ?> </a></li>
                                    <?php } ?>
                                  </ul>
                                </div>
                              </aside>
