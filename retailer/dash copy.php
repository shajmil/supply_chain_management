        ...
        <div class="container">
          <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                  ...
                  <div class="ps-section__content">
                    <div class="ps-product--list">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-detail.html"></a><img src="images/cake/img-cake-6.jpg" alt=""></div>
                      <div class="ps-product__content">
                        <h4 class="ps-product__title"><a href="product-detail.html">Anytime Cakes</a></h4>
                        <p>Lollipop dessert donut marzipan cookie bonbon sesame snaps chocolate.</p>
                        <p class="ps-product__price">
                          <del>£25.00</del>£15.00
                        </p><a class="ps-btn ps-btn--xs" href="cart.html">Order now<i class="fa fa-angle-right"></i></a>
                    ...
                    <div class="ps-product--list">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-detail.html"></a><img src="images/cake/img-cake-8.jpg" alt=""></div>
                      <div class="ps-product__content">
                        <h4 class="ps-product__title"><a href="product-detail.html">Sugar Booger</a></h4>
                        <p>Lollipop dessert donut marzipan cookie bonbon sesame snaps chocolate.</p>
                        <p class="ps-product__price">
                          <del>£25.00</del>£15.00
                        </p><a class="ps-btn ps-btn--xs" href="cart.html">Order now<i class="fa fa-angle-right"></i></a>
                    ...
                    <div class="ps-product--list">
                      <div class="ps-product__thumbnail"><a class="ps-product__overlay" href="product-detail.html"></a><img src="images/cake/img-cake-11.jpg" alt=""></div>
                      <div class="ps-product__content">
                        <h4 class="ps-product__title"><a href="product-detail.html">The Mix-Up</a></h4>
                        <p>Lollipop dessert donut marzipan cookie bonbon sesame snaps chocolate.</p>
                        <p class="ps-product__price">
                          <del>£25.00</del>£15.00
                        </p><a class="ps-btn ps-btn--xs" href="cart.html">Order now<i class="fa fa-angle-right"></i></a>
      ...
      <section class="ps-section ps-section--news pt-100 pb-100">
        <div class="container">
          ...
          <div class="ps-section__content">
            <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                    <div class="ps-new ps-new--large"><img src="images/new/new-large.jpg" alt="">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                    <div class="ps-new"><img src="images/new/new-small-1.jpg" alt="">
                      <div class="ps-new__container">
                        <header class="ps-new__header">
                    ...
                    <div class="ps-new"><img src="images/new/new-small-2.jpg" alt="">
                      <div class="ps-new__container">
                        <header class="ps-new__header">
                          <p>by<a href="#"> Athony</a> / February 12, 2017</p><a class="ps-new__title" href="blog-detail.html">Where I Learning Cook Cupcakes ?</a>
                        </header>
