    ...
    <div class="page-wrap">
      ...
      <div class="ps-section--cart pt-100 pb-100">
        ...
        //  echo $sql;
         ...
         ?>
              <form action="functions/add_to_cart.php?action=add&id=<?php echo $row['pro_id']; ?>" method="post">

                  <tr>
                    <td>
                      <div class="ps-product--cart"><img src="../images/<?php echo $row['pro_photo']; ?>" alt=""></a><center><?php echo $row['pro_name']; ?></center></div>
                    </td>
                   ...
                   <!--  -->
                        ...
                        <input class="form-control" type="text" value="0" id="quantity" name="quantity">     
...
<td><a href="functions/add_to_cart.php?action=delete&id=<?php echo $values["item_id"]; ?>"> <span class="text-danger">Remove</span></a></td>     </td>
...
print_r($_SESSION["total"]);
    ...
    <input type="hidden" name="man_phone" value="<?php echo $row["man_phone"]; ?>" />
                        ...
                        <input type="submit" name="submit"class="ps-btn ps-btn--sm ps-btn--fullwidth">Process to checkout</input>
                        </form>
                      </div>
                    </div>
              </div>
