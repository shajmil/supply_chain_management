...
$sql =" SELECT  invoice.date,invoice.order_id,invoice.status,invoice.dist_id,distributor.dist_name,manufacturer.man_id,manufacturer.man_name,manufacturer.man_phone,manufacturer.man_email FROM `invoice`
...
?>
                        ...
                        <div class="col-md-12">
                           <div class="white_shd full margin_bottom_30">
                              <div class="full graph_head">
                                 ...
                                 <center>
                                 <button class="btn btn-primary btn-sm" id="printpage">Print</button></center>
</div>
                              </div>
                              <div class="full">
    ...
    <h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; From:</h5>
                                             <p><strong> <?php echo $results['man_name']; ?></strong><br>  
                                                ...
                                                <strong>Phone : </strong>  <?php echo $results['man_phone']; ?><br>
                                                <strong>Email : </strong> <?php echo $results['man_email']; ?><br></a>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="col-md-4">
                                       ...
                                       <div class="col-md-4">
                                          <div class="full invoice_blog padding_infor_info padding-bottom_0">
                                             ...
                                             <p><strong>Order ID : </strong>  <?php echo $_GET['id']; ?><br> 
                                                <strong>Invoice Date : </strong><?php echo $result['date']; ?><br> 
                                                <strong>Distributor : </strong><?php echo $results['dist_name']; ?>
