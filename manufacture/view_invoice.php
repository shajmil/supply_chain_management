...
$order_id=$_GET['id'];
$man_id=$_SESSION['id'];
$sq =" SELECT order_items.order_id,retail.retail_username,retail.retail_id,retail.retail_address,retail.retail_phone,retail.retail_email,orders.date,orders.status,order_items.quantity,products.pro_name,orders.total_amount,invoice.invoice_id,invoice.date FROM order_items
...
$sql =" SELECT  invoice.date,invoice.order_id,invoice.status,invoice.dist_id,distributor.dist_name,distributor.dist_phone,manufacturer.man_id,manufacturer.man_name,manufacturer.man_phone,manufacturer.man_email FROM `invoice`
...
?>
                            ...
                            <div class="col-md-12">
                                <div class="white_shd full margin_bottom_30">
                                    <div class="full graph_head">
                                        ...
                                        <div class="heading1 margin_0 row-md-6">
                                            <h2><i class="fa fa-file-text-o"></i> Order ID : <?php echo $_GET['id']; ?>
                                            </h2>
                                        ...
                                        <center>
                                            <button class="btn btn-primary btn-sm" id="printpage">Print</button>
                                        </center>
                                    </div>
                                </div>
                                <div class="full">
      ...
      echo "pending";}else{
        echo"completed";  
                                                    ...
                                                    <h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; From:</h5>
                                                    <p><strong> <?php echo $results['man_name']; ?></strong><br>

                                                        <strong>Phone : </strong>
                                                        <?php echo $results['man_phone']; ?><br>
                                                        <strong>Email : </strong>
                                                        <?php echo $results['man_email']; ?><br></a>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="full invoice_blog padding_infor_info padding-bottom_0">
                                                    ...
                                                    <p><strong> <?php echo $result['retail_username']; ?></strong><br>
                                                        ...
                                                        <strong>Phone : </strong>
                                                        <?php  echo $result['retail_phone']; ?><br>
                                                        <strong>Email :
                                                        </strong><?php echo $result['retail_email']; ?></a>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="full invoice_blog padding_infor_info padding-bottom_0">
                                                    <h4>Invoice No - <?php echo $result['invoice_id']; ?> </h4>
                                                    <p><strong>Order ID : </strong> <?php echo $_GET['id']; ?><br>
                                                        <strong>Invoice Date :
                                                        </strong><?php echo $result['date']; ?><br>
                                                        <strong>Distributor :
                                                        </strong><?php echo $results['dist_name']; ?>
                                                        </strong><?php echo $results['dist_phone']; ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                 ...
                                                 ?>
                                                    ...
                                                    <td><a
                                                            href="functions/confirm_order.php?id=<?php echo $order_id;?>">
                                                            <button class="btn btn-sucess "> confirm</a> </button></td>
                                                    <?php  } ?>
