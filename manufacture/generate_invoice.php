                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="full invoice_blog padding_infor_info padding-bottom_0">
                                                        <h4>INVOICE </h4>
                                                        <p><strong>
                                                                <?php echo $result['retail_username']; ?></strong><br>
                                                ...
                                                <tbody>
                                                 ...
                                                 ?>
                                                        <form class="forms-sample"
                                                            action="functions/confirm_invoice.php" method="POST">
                                                            <h6>select distributor</h6>
                                                            <select name="disid" id="disid">
                                                                <option value="" disabled selected>--- distributor ---
                                                                </option>
                                                                <?php
          include('config/dbconfig.php');
            $sql = 'SELECT * FROM distributor where status >=2';  //2 for confirm 3 for avail  1 for bc
            $query = mysqli_query($conn,$sql);
