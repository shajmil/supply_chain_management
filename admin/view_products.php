      ...
      <div class="container-fluid page-body-wrapper">
       ...
       <?php include 'partials/_navbar.php'; ?>'
        ...
        <td><?php echo $row['man_name']; ?></td>
            ...
            <td><a class="btn btn-sm btn-primary" id="btn-update" href="update_product.php?id=<?php echo $row['pro_id']; ?>" </a> Update</td> 
            <td> <a class="btn btn-sm btn-danger" id="btn-delete" href="functions/delete_product.php?id=<?php echo $row['pro_id']; ?>"<i class="fas fa-trash"></i> Delete</a></td> 
        </tr>
